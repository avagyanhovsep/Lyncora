...
const commentService = new CommentService(models.User, models.Comment, models.CommentReaction, SAFE_USER);
...
loader.validators = {
    deleteCommentValidator: deleteCommentValidator.bind(null, loader.services.commentService),
